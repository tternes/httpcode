			...
			<div class="container">
				...
				<div class="navbar-collapse collapse" id="navbar-main">
					...
					<form class="navbar-form navbar-left" action="/go">
						<input type="text" name="code" class="form-control col-lg-8" placeholder="search codes (e.g. 404)">
					</form>
		...
		<div class="container">
			<div class="page-header" id="banner">
				...
				<div class="row">
					<div class="col-sm-7">
						<h1>Oops!</h1>
						<p class="lead">That status isn&apos;t supported.</p>
						<p>You can <a href="https://github.com/tternes/httpcode/issues">file an issue</a> if you believe this is an issue.</p>
						
						<p>In lieu of the page you were looking for, here is 404.</p>
						<pre><small><?php require_once("404.curl.php"); ?></small></pre>
					</div>
					...
					<div class="col-sm-5">
						...
						<div class="panel panel-primary">
							...
							<pre>~$ curl http://httpcode.info/404</pre>
							</div>
						</div>
