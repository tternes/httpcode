			...
			<div class="page-header" id="banner">
				...
				<div class="row">
					<div class="col-sm-7">
						...
						<p class="lead"></p>
						<pre><small>The requested resource has been assigned a new permanent URI and any
...
will erroneously change it into a GET request.</small></pre>
					</div>
					...
					<div class="col-sm-5">
						...
						<div class="panel panel-primary">
							...
							<pre>~$ curl http://httpcode.info/301</pre>
							</div>
						</div>
